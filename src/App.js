  ...
  return (
    ...
    >
      <header className="header" ref={headerRef}>
        ...
        <p className="header-title">Middleby Search</p>

        <SearchBox
          translations={{
            placeholder: "Product, vendor name, color, …",
          }}
          submit={
            <svg
        ...
        <div className="container-wrapper">
          <section className="container-filters" onKeyUp={onKeyUp}>
            ...
            <div className="container-body">
              ...
              <Panel header="Vendor Name">
                <RefinementList
                  attribute="Vendor Name"
                  searchable={true}
                  translations={{
                    placeholder: "Search for vendor names...",
                  }}
                />
              </Panel>
            </div>
  ...
  return (
    <article className="hit">
      <header className="hit-image-container">
        <img
          src="https://media.salon.com/2013/08/shutterstock_55573504.jpg"
          className="hit-image"
          alt={props.hit.Spec}
        />
      </header>
      ...
      <div className="hit-info-container">
        <p className="hit-category">
          <Highlight attribute="SuperCategory" hit={props.hit} />
        </p>
        <h1>
          <Highlight attribute="Model" hit={props.hit} />
        </h1>
        <p className="hit-description">
          <Snippet attribute="Spec" hit={props.hit} />
        </p>

        <footer>
          <p>
            <span className="hit-em">$</span>
            <strong>{formatNumber(150)}</strong>{" "}
          </p>
        </footer>
      </div>
    </article>
