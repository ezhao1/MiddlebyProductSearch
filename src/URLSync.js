...
const encodedCategories = {
  ...
  FoodRefrigeration: "Food Refrigeration",
  FoodPreparation: "Food Preparation",
  NULL: "None",
  BeverageEquipment: "Beverage Equipment",
  FoodHolding: "Food Holding & Warming Equipment",
};
...
const searchStateToURL = (searchState) => {
  const routeState = {
    ...
    category:
      ...
      searchState.hierarchicalMenu["SuperCategory.lvl0"],
    rating:
      searchState.range &&
